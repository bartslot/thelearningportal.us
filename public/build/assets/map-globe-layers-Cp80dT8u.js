import{m as j}from"./map-imagery-GrMwsaGI.js";import{p as mt}from"./tuner-xnBLRIk5.js";const se=63710088e-1,K=(e,a,r=0)=>{const l=1+Math.max(0,r)/se,h=a*Math.PI/180,u=e*Math.PI/180;return[Math.cos(h)*Math.cos(u)*l,Math.sin(h)*l,Math.cos(h)*Math.sin(u)*l]},pt=e=>(2*Math.atan(Math.exp((1-2*e)*Math.PI))-Math.PI/2)*180/Math.PI,Te=e=>.5-Math.log(Math.tan(Math.PI/4+e*Math.PI/180/2))/(2*Math.PI),Ae=85.0511287798066,gt=89.999,ue=6,le=(e=64,a=48)=>{const r=[],l=[],h=[],u=i=>Ae+(gt-Ae)*(i/ue),t=[];for(let i=ue;i>=1;i--)t.push(Te(u(i)));for(let i=0;i<=a;i++)t.push(i/a);for(let i=1;i<=ue;i++)t.push(Te(-u(i)));for(const i of t){const x=pt(i)*Math.PI/180;for(let L=0;L<=e;L++){const p=L/e,C=(p*360-180)*Math.PI/180;r.push(p,i),l.push(Math.cos(x)*Math.cos(C),Math.sin(x),Math.cos(x)*Math.sin(C))}}const _=e+1;for(let i=0;i<t.length-1;i++)for(let x=0;x<e;x++){const L=i*_+x,p=L+_;h.push(L,p,L+1,p,p+1,L+1)}return{positions:new Float32Array(r),spheres:new Float32Array(l),indices:new Uint16Array(h),vertexCount:(e+1)*t.length,rowCount:t.length}},he=`
...
`,ve=(e,a)=>{const r=e?.transform,l=typeof r?.getCameraAltitude=="function"?r.getCameraAltitude():null;if(Number.isFinite(l))return l;const h=r?.cameraToCenterDistance;if(!Number.isFinite(h))return 1e7;const u=512*Math.pow(2,e.getZoom()),t=1/a.MercatorCoordinate.fromLngLat(e.getCenter(),0).meterInMercatorCoordinateUnits();return h/u*t*Math.cos(e.getPitch()*Math.PI/180)},J=(e,a)=>{const r=e?.transform?.cameraPosition;if(r&&Number.isFinite(r[0])&&Number.isFinite(r[1])&&Number.isFinite(r[2]))return[r[2],r[1],r[0]];const l=e?.transform,h=typeof l?.getCameraLngLat=="function"?l.getCameraLngLat():e.getCenter();return K(h.lng,h.lat,ve(e,a))},$e=e=>typeof e.texStorage2D=="function",wt=`#version 300 es
#define attribute in
#define varying out
...
`,Z=(e,a,r,l="layer",{es300:h=!1}={})=>(h&&$e(e)&&(a=wt+a,r=_t+r),bt(e,a,r,l)),bt=(e,a,r,l)=>{const h=(i,x)=>{const L=e.createShader(i);if(e.shaderSource(L,x),e.compileShader(L),!e.getShaderParameter(L,e.COMPILE_STATUS)){const p=e.getShaderInfoLog(L);throw e.deleteShader(L),new Error(`${l} shader: ${p}`)}return L},u=e.createProgram(),t=h(e.VERTEX_SHADER,a),_=h(e.FRAGMENT_SHADER,r);if(e.attachShader(u,t),e.attachShader(u,_),e.linkProgram(u),e.deleteShader(t),e.deleteShader(_),!e.getProgramParameter(u,e.LINK_STATUS)){const i=e.getProgramInfoLog(u);throw e.deleteProgram(u),new Error(`${l} link: ${i}`)}return u},ce=`
...
`,je=["time","drift","field","fieldAmount","wind","windAmount","windScale","windRate","patches","patchAmount","patchTiles","patchMean","patchDetail"],vt=.75,yt=144,Et=.4359,Ye=(e,a,r,l,h,u,t)=>{const _=r.animate?l.seconds:0;a.time&&e.uniform1f(a.time,_),a.drift&&e.uniform1f(a.drift,_*r.driftRate),a.fieldAmount&&e.uniform1f(a.fieldAmount,l.field?.ready?1:0),a.patchAmount&&e.uniform1f(a.patchAmount,l.patches?.ready?1:0),a.patchTiles&&e.uniform1f(a.patchTiles,r.patchTiles??yt),a.patchMean&&e.uniform1f(a.patchMean,r.patchMean??Et),a.patchDetail&&e.uniform1f(a.patchDetail,r.patchDetail??vt),a.windAmount&&e.uniform1f(a.windAmount,l.wind?.ready?r.windAmount:0),a.windScale&&e.uniform1f(a.windScale,r.windScale),a.windRate&&e.uniform1f(a.windRate,r.animate?r.windRate:0),l.field?.ready&&a.field&&(e.activeTexture(e.TEXTURE0+h),e.bindTexture(e.TEXTURE_2D,l.field.texture),e.uniform1i(a.field,h)),l.wind?.ready&&a.wind&&(e.activeTexture(e.TEXTURE0+u),e.bindTexture(e.TEXTURE_2D,l.wind.texture),e.uniform1i(a.wind,u)),l.patches?.ready&&a.patches&&(e.activeTexture(e.TEXTURE0+t),e.bindTexture(e.TEXTURE_2D,l.patches.texture),e.uniform1i(a.patches,t))},xe=new WeakMap,Tt=e=>{let a=xe.get(e);return a||(a=new Map,xe.set(e,a)),a},At=(e,a,r)=>{const l=e.createTexture();return e.bindTexture(e.TEXTURE_2D,l),e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,!1),e.texImage2D(e.TEXTURE_2D,0,e.RGBA,e.RGBA,e.UNSIGNED_BYTE,a),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.REPEAT),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,r?e.LINEAR_MIPMAP_LINEAR:e.LINEAR),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.LINEAR),r&&e.generateMipmap(e.TEXTURE_2D),l},W=(e,a,r=null,{mipmap:l=!0}={})=>{const h=Tt(e),u=`${a}|${l?"mip":"flat"}`;let t=h.get(u);if(!t){t={texture:null,ready:!1,refs:0,waiters:[],width:0},h.set(u,t);const i=new Image;i.crossOrigin="anonymous",i.onload=()=>{if(t.refs===0)return;const x=e.getParameter?.(e.MAX_TEXTURE_SIZE)??1/0;if(i.width>x){t.waiters=[];return}t.width=i.width,t.texture=At(e,i,l),t.ready=!0;const L=t.waiters;t.waiters=[],L.forEach(p=>p())},i.onerror=()=>{t.waiters=[]},i.src=a}t.refs++;let _=!0;return r&&(t.ready?r():t.waiters.push(r)),{get texture(){return t.texture},get ready(){return t.ready},get width(){return t.width},release(){_&&(_=!1,r&&(t.waiters=t.waiters.filter(i=>i!==r)),t.refs--,!(t.refs>0)&&(t.texture&&e.deleteTexture(t.texture),t.texture=null,t.ready=!1,h.delete(u)))}}},Xe=`
...
`,Rt=(e,a)=>2*Math.PI*se*Math.cos(a*Math.PI/180)/e,Mt=(e,a,r)=>Math.min(r,Math.max(a,e)),kt=(e,a,r)=>{const l=Mt((r-e)/(a-e),0,1);return l*l*(3-2*l)},St=(e,a,r)=>{const l=156543.03392*Math.cos(a*Math.PI/180)/Math.pow(2,e)/2,h=Rt(r,a)/l;return{pixelsPerTexel:h,strength:1-kt(3,5,Math.log2(Math.max(h,1e-6)))}},Ke="tm-clouds",Lt=(e,a,r)=>{const l=156543.03392*Math.cos(a*Math.PI/180)/Math.pow(2,e),u=156543.03392/2**8,t=Math.min(1,l/u),i=se/Math.max(1,l*110);return{frequency:Math.min(2600,Math.max(9,i)),amount:.14+(1-t)*.1,fade:Number.isFinite(r)?Ut(1.35,2.75,r/oe):0}},Ut=(e,a,r)=>{const l=Math.min(1,Math.max(0,(r-e)/(a-e)));return l*l*(3-2*l)},Dt=e=>`#version 300 es
${e.define}
...
}`,It=({opacity:e=.5,animate:a=!0,fieldUrl:r=null,patchUrl:l=null,driftRate:h=4e-4,sun:u=[.4,.5,.75],windUrl:t=null,windAmount:_=1,windScale:i=.06,windRate:x=.05,cloudRelief:L=90,cloudDepth:p=4,powder:C=1,forward:c=.5,forwardG:v=.7,selfShadow:n=.18,selfShadowStep:y=.0015}={})=>{const T=le();let F=null,s=null,o=null;const H=new Map;let k={opacity:e,animate:a,fieldUrl:r,patchUrl:l,driftRate:h,sun:u,windUrl:t,windAmount:_,windScale:i,windRate:x,cloudRelief:L,cloudDepth:p,powder:C,forward:c,forwardG:v,selfShadow:n,selfShadowStep:y},f=null,d=null,P=null;const U=A=>{const E=A.variantName;if(H.has(E))return H.get(E);const g=Z(s,Dt(A),Pt(),"tm-clouds"),w={program:g,attribs:{pos:s.getAttribLocation(g,"a_pos"),sphere:s.getAttribLocation(g,"a_sphere")},uniforms:{elevationGlobe:s.getUniformLocation(g,"a_elevation_globe"),elevationMercator:s.getUniformLocation(g,"a_elevation_mercator"),opacity:s.getUniformLocation(g,"u_opacity"),sun:s.getUniformLocation(g,"u_sun"),...Object.fromEntries(je.map(m=>[m,s.getUniformLocation(g,`u_${m}`)])),detailFreq:s.getUniformLocation(g,"u_detailFreq"),detailAmount:s.getUniformLocation(g,"u_detailAmount"),deckFade:s.getUniformLocation(g,"u_deckFade"),camera:s.getUniformLocation(g,"u_camera"),cloudRelief:s.getUniformLocation(g,"u_cloudRelief"),cloudDepth:s.getUniformLocation(g,"u_cloudDepth"),powder:s.getUniformLocation(g,"u_powder"),forward:s.getUniformLocation(g,"u_forward"),forwardG:s.getUniformLocation(g,"u_forwardG"),selfShadow:s.getUniformLocation(g,"u_selfShadow"),selfShadowStep:s.getUniformLocation(g,"u_selfShadowStep"),matrix:s.getUniformLocation(g,"u_projection_matrix"),tileMercatorCoords:s.getUniformLocation(g,"u_projection_tile_mercator_coords"),clippingPlane:s.getUniformLocation(g,"u_projection_clipping_plane"),transition:s.getUniformLocation(g,"u_projection_transition"),fallbackMatrix:s.getUniformLocation(g,"u_projection_fallback_matrix")}};return H.set(E,w),w},G=(A,E)=>{A.matrix&&s.uniformMatrix4fv(A.matrix,!1,E.mainMatrix),A.tileMercatorCoords&&s.uniform4f(A.tileMercatorCoords,...E.tileMercatorCoords),A.clippingPlane&&s.uniform4f(A.clippingPlane,...E.clippingPlane),A.transition&&s.uniform1f(A.transition,E.projectionTransition),A.fallbackMatrix&&s.uniformMatrix4fv(A.fallbackMatrix,!1,E.fallbackMatrix)},B=()=>F?.triggerRepaint();return{id:Ke,type:"custom",renderingMode:"3d",onAdd(A,E){F=A,s=E;const g=(w,m)=>{const D=s.createBuffer();return s.bindBuffer(w,D),s.bufferData(w,m,s.STATIC_DRAW),D};o={pos:g(s.ARRAY_BUFFER,T.positions),sphere:g(s.ARRAY_BUFFER,T.spheres),index:g(s.ELEMENT_ARRAY_BUFFER,T.indices)},k.fieldUrl&&(f=W(s,k.fieldUrl,B)),k.windUrl&&(d=W(s,k.windUrl,B)),k.patchUrl&&(P=W(s,k.patchUrl,B))},onRemove(){s&&(H.forEach(({program:A})=>s.deleteProgram(A)),H.clear(),f?.release(),f=null,d?.release(),d=null,P?.release(),P=null,o&&(s.deleteBuffer(o.pos),s.deleteBuffer(o.sphere),s.deleteBuffer(o.index),o=null),F=null,s=null)},render(A,E){if(!o||k.opacity<=0)return;const g=E&&E.shaderData,w=E&&E.defaultProjectionData;if(!g||!w)return;const{program:m,attribs:D,uniforms:I}=U(g);s.useProgram(m),G(I,w);const N=F.getCenter().lat;I.elevationGlobe&&s.uniform1f(I.elevationGlobe,oe),I.elevationMercator&&s.uniform1f(I.elevationMercator,j.MercatorCoordinate.fromLngLat([0,N],oe).z),I.opacity&&s.uniform1f(I.opacity,k.opacity),I.sun&&s.uniform3f(I.sun,...k.sun),Ye(s,I,k,{seconds:performance.now()*.001,field:f,wind:d,patches:P},0,1,2);const b=Lt(F.getZoom(),F.getCenter().lat,ve(F,j));I.detailFreq&&s.uniform1f(I.detailFreq,b.frequency),I.detailAmount&&s.uniform1f(I.detailAmount,b.amount),I.deckFade&&s.uniform1f(I.deckFade,b.fade),I.camera&&s.uniform3f(I.camera,...J(F,j));const R=M=>{I[M]&&s.uniform1f(I[M],k[M])};R("cloudRelief"),R("cloudDepth"),R("powder"),R("forward"),R("forwardG"),R("selfShadow"),R("selfShadowStep"),s.bindBuffer(s.ARRAY_BUFFER,o.pos),s.enableVertexAttribArray(D.pos),s.vertexAttribPointer(D.pos,2,s.FLOAT,!1,0,0),s.bindBuffer(s.ARRAY_BUFFER,o.sphere),s.enableVertexAttribArray(D.sphere),s.vertexAttribPointer(D.sphere,3,s.FLOAT,!1,0,0),s.enable(s.DEPTH_TEST),s.depthFunc(s.LEQUAL),s.depthMask(!1),s.bindBuffer(s.ELEMENT_ARRAY_BUFFER,o.index),s.drawElements(s.TRIANGLES,T.indices.length,s.UNSIGNED_SHORT,0),s.depthMask(!0),k.animate&&F.triggerRepaint()},setOptions(A={}){const E=k;if(k={...k,...A},s){const g=(w,m)=>A[m]===void 0||A[m]===E[m]?w:(w?.release(),k[m]?W(s,k[m],B):null);f=g(f,"fieldUrl"),P=g(P,"patchUrl")}F&&F.triggerRepaint()},getOptions:()=>({...k}),get hasField(){return!!(f?.ready||P?.ready)}}},Ct=Ke,X=Math.PI/180,Ft=Date.UTC(2e3,0,1,12),fe=1/3600,Ve=e=>(e.getTime()-Ft)/864e5,Nt=(e=new Date)=>((18.697374558+24.06570982441908*Ve(e))%24*15%360+360)%360,Ot=e=>{const a=Ve(e)/36525;return{zeta:(2306.2181*a+.30188*a*a+.017998*a*a*a)*fe,z:(2306.2181*a+1.09468*a*a+.018203*a*a*a)*fe,theta:(2004.3109*a-.42665*a*a-.041833*a*a*a)*fe}},Bt=(e,a,r)=>{const{zeta:l,z:h,theta:u}=Ot(r),t=(e-h)*X,_=a*X,i=u*X,x=Math.cos(_)*Math.sin(t),L=Math.cos(i)*Math.cos(_)*Math.cos(t)+Math.sin(i)*Math.sin(_),p=-Math.sin(i)*Math.cos(_)*Math.cos(t)+Math.cos(i)*Math.sin(_);return{ra:Math.atan2(x,L)/X-l,dec:Math.asin(Math.min(1,Math.max(-1,p)))/X}},Re=e=>(e%360+360)%360,Ht=(e,a=new Date)=>{const r=Math.hypot(e[0],e[1],e[2])||1,l=Math.atan2(e[2]/r,e[0]/r)/X,h=Math.asin(Math.min(1,Math.max(-1,e[1]/r)))/X,u=Bt(Re(l+Nt(a)),h,a);return{ra:Re(u.ra),dec:u.dec}},Gt=`
...
`,zt=(e=new Date)=>{const a=new Float32Array(9);return[[1,0,0],[0,1,0],[0,0,1]].forEach((l,h)=>{const{ra:u,dec:t}=Ht(l,e);a[h*3]=Math.cos(t*X)*Math.cos(u*X),a[h*3+1]=Math.sin(t*X),a[h*3+2]=Math.cos(t*X)*Math.sin(u*X)}),a},$t=Math.PI/180,ie=e=>{const a=Math.hypot(e[0],e[1],e[2])||1;return[e[0]/a,e[1]/a,e[2]/a]},qt=(e,a)=>e[0]*a[0]+e[1]*a[1]+e[2]*a[2],ge=(e,a)=>[e[0]-a[0],e[1]-a[1],e[2]-a[2]],Me=(e,a)=>{const r=qt(e,a);return ie([e[0]-a[0]*r,e[1]-a[1]*r,e[2]-a[2]*r])},jt=(e,a)=>{const l=a>89.98?-1:1,h=ie(ge(K(e,a+.01*l),K(e,a-.01*l))),u=ie(ge(K(e+.01,a),K(e-.01,a)));return{north:l===1?h:[-h[0],-h[1],-h[2]],east:u}},Yt=(e,a,r,l)=>{const h=e.getCenter(),u=(e.getBearing?.()??0)*$t,t=K(h.lng,h.lat,0),_=J(e,a),i=ie(ge(t,_)),{north:x,east:L}=jt(h.lng,h.lat),p=[0,1,2].map(T=>x[T]*Math.cos(u)+L[T]*Math.sin(u)),C=[0,1,2].map(T=>-x[T]*Math.sin(u)+L[T]*Math.cos(u)),c=Me(p,i),v=Me(C,i),n=Math.tan(r/2),y=n*l;return{origin:_,forward:i,up:c.map(T=>T*n),right:v.map(T=>T*y),upUnit:c,rightUnit:v}},we=(e,a)=>e*a*4,Ze=[{name:"high",width:4096,height:2048,url:"/img/map/sky/milkyway-4k.webp",bytes:3680220,resident:we(4096,2048),decodeMs:235},{name:"standard",width:2048,height:1024,url:"/img/map/sky/milkyway-2k.webp",bytes:764012,resident:we(2048,1024),decodeMs:51}],Qe={name:"placeholder",width:1024,height:512,url:"/img/map/sky/milkyway-1k.webp",bytes:45160,resident:we(1024,512),decodeMs:5},Xt=4,Wt=4,Kt=({maxTextureSize:e=0,deviceMemory:a=null,hardwareConcurrency:r=null,saveData:l=!1,effectiveType:h=null}={})=>{const u=Ze.filter(i=>i.width<=e);if(u.length===0)return{tier:Qe,reason:`MAX_TEXTURE_SIZE is ${e}, below every tier — falling back to the placeholder`};const t=u[u.length-1],_=u[0];return _===t?{tier:_,reason:`only ${_.name} fits MAX_TEXTURE_SIZE ${e}`}:l?{tier:t,reason:"the browser is in data-saver mode"}:h&&/^(slow-2g|2g|3g)$/.test(h)?{tier:t,reason:`the connection reports ${h}`}:Number.isFinite(a)&&a<Xt?{tier:t,reason:`the device reports ${a} GB of memory`}:Number.isFinite(r)&&r<Wt?{tier:t,reason:`the device reports ${r} cores`}:{tier:_,reason:`nothing says otherwise, and MAX_TEXTURE_SIZE is ${e}`}},Vt=(e,a=typeof navigator>"u"?null:navigator)=>{const r=a?.connection??null;return{maxTextureSize:e?.getParameter?.(e.MAX_TEXTURE_SIZE)??0,deviceMemory:a?.deviceMemory??null,hardwareConcurrency:a?.hardwareConcurrency??null,saveData:r?.saveData??!1,effectiveType:r?.effectiveType??null}},Je="tm-starfield",Zt=Qe.url,Qt="/data/sky/bright-stars.bin",Jt=e=>{const a=Number.isFinite(e)?e:5800,r=Math.min(4e4,Math.max(1e3,a))/100,l=x=>Math.min(1,Math.max(0,x/255)),h=r<=66?255:329.698727446*Math.pow(r-60,-.1332047592),u=r<=66?99.4708025861*Math.log(r)-161.1195681661:288.1221695283*Math.pow(r-60,-.0755148492),t=r>=66?255:r<=19?0:138.5177312231*Math.log(r-10)-305.0447927307,_=[l(h),l(u),l(t)],i=Math.max(..._)||1;return _.map(x=>x/i)},ea=(e,{limitMagnitude:a=6.5}={})=>{const r=new Float32Array(e),l=Math.floor(r.length/4),h=[];for(let t=0;t<l;t++){const _=r[t*4+2];if(_>a)continue;const i=Math.pow(10,-.4*_);h.push([r[t*4],r[t*4+1],Math.pow(i,.36),...Jt(r[t*4+3])])}const u=new Float32Array(h.length*6);return h.forEach((t,_)=>u.set(t,_*6)),{vertices:u,count:h.length}},et=`
  uniform vec3 u_camera;      // camera in planet space, earth = unit sphere
...
}`,ra=({textureUrl:e=null,placeholderUrl:a=Zt,catalogueUrl:r=Qt,date:l=new Date,brightness:h=.55,nebula:u=.3,nebulaContrast:t=1.45,starDensity:_=210,starAmount:i=1.5,catalogueAmount:x=2.2,starSize:L=3,limitMagnitude:p=6.5,twinkle:C=0,animate:c=!1}={})=>{let v=null,n=null,y=null,T=null,F=null,s=null,o="not chosen yet",H=0;const k=new Map;let f={textureUrl:e,placeholderUrl:a,catalogueUrl:r,date:l,brightness:h,nebula:u,nebulaContrast:t,starDensity:_,starAmount:i,catalogueAmount:x,starSize:L,limitMagnitude:p,twinkle:C,animate:c};const d=A=>{const E=A.variantName;if(k.has(E))return k.get(E);const g=Z(n,ta(A),aa(A),"tm-starfield"),w=Z(n,oa(A),ia(A),"tm-starfield-catalogue"),m=(I,N)=>n.getUniformLocation(I,N),D={sky:{program:g,pos:n.getAttribLocation(g,"a_pos"),uniforms:{camera:m(g,"u_camera"),forward:m(g,"u_forward"),right:m(g,"u_right"),up:m(g,"u_up"),halfExtent:m(g,"u_halfExtent"),skyFrame:m(g,"u_skyFrame"),sky:m(g,"u_sky"),globeness:m(g,"u_globeness"),brightness:m(g,"u_brightness"),nebula:m(g,"u_nebula"),nebulaContrast:m(g,"u_nebulaContrast"),starDensity:m(g,"u_starDensity"),starAmount:m(g,"u_starAmount"),twinkle:m(g,"u_twinkle"),time:m(g,"u_time")}},stars:{program:w,star:n.getAttribLocation(w,"a_star"),colour:n.getAttribLocation(w,"a_colour"),uniforms:{camera:m(w,"u_camera"),forward:m(w,"u_forward"),right:m(w,"u_right"),up:m(w,"u_up"),halfExtent:m(w,"u_halfExtent"),skyFrame:m(w,"u_skyFrame"),pixelRatio:m(w,"u_pixelRatio"),starSize:m(w,"u_starSize"),catalogueAmount:m(w,"u_catalogueAmount")}}};return k.set(E,D),D},P=()=>{if(!n)return;const A=(E,g)=>E?W(n,E,g,{mipmap:!1}):null;if(f.textureUrl===null){const E=Kt(Vt(n));s=E.tier,o=E.reason}else s=Ze.find(E=>E.url===f.textureUrl)??{name:"explicit",url:f.textureUrl},o="the caller named a panorama";F=A(f.placeholderUrl,()=>{v?.triggerRepaint()}),T=A(s.url===f.placeholderUrl?null:s.url,()=>{F?.release(),F=null,v?.triggerRepaint()})},U=()=>T?.ready?T:F?.ready?F:null,G=()=>{T?.release(),F?.release(),T=null,F=null},B=A=>{!A||typeof fetch!="function"||fetch(A).then(E=>{if(!E.ok)throw new Error(`${E.status} ${E.statusText}`);return E.arrayBuffer()}).then(E=>{if(!n||!y)return;const{vertices:g,count:w}=ea(E,{limitMagnitude:f.limitMagnitude});n.bindBuffer(n.ARRAY_BUFFER,y.stars),n.bufferData(n.ARRAY_BUFFER,g,n.STATIC_DRAW),H=w,v?.triggerRepaint()}).catch(E=>console.warn(`[starfield] bright star catalogue unavailable: ${E.message}`))};return{id:Je,type:"custom",renderingMode:"3d",onAdd(A,E){v=A,n=E;const g=(w,m)=>{const D=n.createBuffer();return n.bindBuffer(w,D),m&&n.bufferData(w,m,n.STATIC_DRAW),D};y={pos:g(n.ARRAY_BUFFER,new Float32Array([-1,-1,1,-1,-1,1,1,1])),index:g(n.ELEMENT_ARRAY_BUFFER,new Uint16Array([0,1,2,2,1,3])),stars:g(n.ARRAY_BUFFER,null)},P(),B(f.catalogueUrl)},onRemove(){n&&(k.forEach(({sky:A,stars:E})=>{n.deleteProgram(A.program),n.deleteProgram(E.program)}),k.clear(),G(),y&&(n.deleteBuffer(y.pos),n.deleteBuffer(y.index),n.deleteBuffer(y.stars),y=null),v=null,n=null)},render(A,E){if(!y||f.brightness<=0)return;const g=E&&E.shaderData,w=E&&E.defaultProjectionData;if(!g||!w)return;const m=v.getCanvas(),D=m.width/Math.max(1,m.height),I=Yt(v,j,E.fov||.6435,D),N=Math.tan((E.fov||.6435)/2),b=zt(f.date),R=w.projectionTransition,{sky:M,stars:O}=d(g),Y=({uniforms:$})=>{$.camera&&n.uniform3f($.camera,...I.origin),$.forward&&n.uniform3f($.forward,...I.forward),$.right&&n.uniform3f($.right,...I.rightUnit),$.up&&n.uniform3f($.up,...I.upUnit),$.halfExtent&&n.uniform2f($.halfExtent,N*D,N),$.skyFrame&&n.uniformMatrix3fv($.skyFrame,!1,b)};n.useProgram(M.program),Y(M),M.uniforms.globeness&&n.uniform1f(M.uniforms.globeness,R),M.uniforms.brightness&&n.uniform1f(M.uniforms.brightness,f.brightness);const S=U();M.uniforms.nebula&&n.uniform1f(M.uniforms.nebula,S?f.nebula:0),M.uniforms.nebulaContrast&&n.uniform1f(M.uniforms.nebulaContrast,f.nebulaContrast),M.uniforms.starDensity&&n.uniform1f(M.uniforms.starDensity,f.starDensity),M.uniforms.starAmount&&n.uniform1f(M.uniforms.starAmount,f.starAmount),M.uniforms.twinkle&&n.uniform1f(M.uniforms.twinkle,f.twinkle),M.uniforms.time&&n.uniform1f(M.uniforms.time,f.animate?performance.now()*.001:0),S&&M.uniforms.sky&&(n.activeTexture(n.TEXTURE0),n.bindTexture(n.TEXTURE_2D,S.texture),n.uniform1i(M.uniforms.sky,0)),n.bindBuffer(n.ARRAY_BUFFER,y.pos),n.enableVertexAttribArray(M.pos),n.vertexAttribPointer(M.pos,2,n.FLOAT,!1,0,0),n.disable(n.DEPTH_TEST),n.depthMask(!1),n.bindBuffer(n.ELEMENT_ARRAY_BUFFER,y.index),n.drawElements(n.TRIANGLES,6,n.UNSIGNED_SHORT,0),H>0&&R>.5&&f.catalogueAmount>0&&(n.useProgram(O.program),Y(O),O.uniforms.pixelRatio&&n.uniform1f(O.uniforms.pixelRatio,typeof devicePixelRatio=="number"?devicePixelRatio:1),O.uniforms.starSize&&n.uniform1f(O.uniforms.starSize,f.starSize),O.uniforms.catalogueAmount&&n.uniform1f(O.uniforms.catalogueAmount,f.catalogueAmount*f.brightness),n.bindBuffer(n.ARRAY_BUFFER,y.stars),n.enableVertexAttribArray(O.star),n.vertexAttribPointer(O.star,3,n.FLOAT,!1,24,0),n.enableVertexAttribArray(O.colour),n.vertexAttribPointer(O.colour,3,n.FLOAT,!1,24,12),n.drawArrays(n.POINTS,0,H),n.disableVertexAttribArray(O.star),n.disableVertexAttribArray(O.colour)),n.enable(n.DEPTH_TEST),n.depthMask(!0),f.animate&&f.twinkle>0&&v.triggerRepaint()},setOptions(A={}){const E=f.textureUrl,g=f.catalogueUrl;f={...f,...A},A.textureUrl!==void 0&&A.textureUrl!==E&&(G(),P()),A.catalogueUrl!==void 0&&A.catalogueUrl!==g&&(H=0,B(A.catalogueUrl)),v?.triggerRepaint()},getOptions:()=>({...f}),get hasSky(){return U()!==null},get starCount(){return H},get skyTier(){return s?{...s,reason:o}:null}}},na=Je,V=Math.PI/180,sa=Date.UTC(2e3,0,1,12),la=149597870700,ha=6957e5,tt=e=>(e.getTime()-sa)/864e5,at=(e=new Date)=>{const a=tt(e),r=(280.46+.9856474*a)%360,l=(357.528+.9856003*a)%360*V,h=(r+1.915*Math.sin(l)+.02*Math.sin(2*l))*V,u=(23.439-4e-7*a)*V,t=Math.asin(Math.sin(u)*Math.sin(h))/V;let _=Math.atan2(Math.cos(u)*Math.sin(h),Math.cos(h))/V;_<0&&(_+=360);let i=r-_;i>180&&(i-=360),i<-180&&(i+=360),i*=4;const x=(1.00014-.01671*Math.cos(l)-14e-5*Math.cos(2*l))*la;return{declination:t,equationOfTime:i,distance:x}},ot=(e=new Date)=>at(e).distance,ca=(e=new Date)=>Math.atan(ha/ot(e)),da=(e=new Date)=>{const a=(357.528+.9856003*tt(e))%360*V;return(1.00014-.01671*Math.cos(a)-14e-5*Math.cos(2*a))*149597870700},ua=(e=new Date)=>{const{declination:a,equationOfTime:r}=at(e);let h=-15*(e.getUTCHours()+e.getUTCMinutes()/60+e.getUTCSeconds()/3600-12+r/60);return h=(h+540)%360-180,{lng:h,lat:a}},re=(e=new Date)=>{const{lng:a,lat:r}=ua(e),l=r*V,h=a*V;return[Math.cos(l)*Math.cos(h),Math.sin(l),Math.cos(l)*Math.sin(h)]},it="tm-sun",ke=63710088e-1,fa=18,ma=(e,a,r)=>{const l=Math.abs(e),h=a,u=r;if(h<=0)return 0;if(l>=h+u)return 1;if(l<=u-h)return 0;if(l<=h-u)return 1-u*u/(h*h);const t=h*h*Math.acos(ee((l*l+h*h-u*u)/(2*l*h),-1,1))+u*u*Math.acos(ee((l*l+u*u-h*h)/(2*l*u),-1,1))-.5*Math.sqrt(Math.max(0,(-l+h+u)*(l+h-u)*(l-h+u)*(l+h+u)));return ee(1-t/(Math.PI*h*h),0,1)},Se={u1:.93,u2:-.23},Le=e=>e<0?`(${e.toFixed(4)})`:e.toFixed(4),pa=`
...
}`,ba=({date:e=new Date,haloScale:a=fa,haloStrength:r=1,discGain:l=1.15,brightness:h=1,coreColour:u=[1,.985,.95],haloColour:t=[1,.65,.2]}={})=>{let _=null,i=null,x=null;const L=new Map;let p={date:e,haloScale:a,haloStrength:r,discGain:l,brightness:h,coreColour:u,haloColour:t};const C=c=>{const v=c.variantName;if(L.has(v))return L.get(v);const n=Z(i,wa(c),_a(),"tm-sun"),y={program:n,attribs:{corner:i.getAttribLocation(n,"a_corner")},uniforms:{centre:i.getUniformLocation(n,"a_centre"),elevationGlobe:i.getUniformLocation(n,"a_elevation_globe"),elevationMercator:i.getUniformLocation(n,"a_elevation_mercator"),size:i.getUniformLocation(n,"u_size"),camera:i.getUniformLocation(n,"u_camera"),forward:i.getUniformLocation(n,"u_forward"),right:i.getUniformLocation(n,"u_right"),up:i.getUniformLocation(n,"u_up"),glowAngle:i.getUniformLocation(n,"u_glow_angle"),discFraction:i.getUniformLocation(n,"u_disc_fraction"),discGain:i.getUniformLocation(n,"u_disc_gain"),visible:i.getUniformLocation(n,"u_visible"),brightness:i.getUniformLocation(n,"u_brightness"),haloStrength:i.getUniformLocation(n,"u_halo_strength"),coreColour:i.getUniformLocation(n,"u_core_colour"),haloColour:i.getUniformLocation(n,"u_halo_colour"),matrix:i.getUniformLocation(n,"u_projection_matrix"),tileMercatorCoords:i.getUniformLocation(n,"u_projection_tile_mercator_coords"),clippingPlane:i.getUniformLocation(n,"u_projection_clipping_plane"),transition:i.getUniformLocation(n,"u_projection_transition"),fallbackMatrix:i.getUniformLocation(n,"u_projection_fallback_matrix")}};return L.set(v,y),y};return{id:it,type:"custom",renderingMode:"3d",onAdd(c,v){_=c,i=v;const n=i.createBuffer();i.bindBuffer(i.ARRAY_BUFFER,n),i.bufferData(i.ARRAY_BUFFER,ga,i.STATIC_DRAW);const y=i.createBuffer();i.bindBuffer(i.ELEMENT_ARRAY_BUFFER,y),i.bufferData(i.ELEMENT_ARRAY_BUFFER,Ue,i.STATIC_DRAW),x={corner:n,index:y}},onRemove(){i&&(L.forEach(({program:c})=>i.deleteProgram(c)),L.clear(),x&&(i.deleteBuffer(x.corner),i.deleteBuffer(x.index),x=null),_=null,i=null)},render(c,v){if(!x||p.brightness<=0)return;const n=v&&v.shaderData,y=v&&v.defaultProjectionData;if(!n||!y)return;const{program:T,attribs:F,uniforms:s}=C(n);i.useProgram(T),s.matrix&&i.uniformMatrix4fv(s.matrix,!1,y.mainMatrix),s.tileMercatorCoords&&i.uniform4f(s.tileMercatorCoords,...y.tileMercatorCoords),s.clippingPlane&&i.uniform4f(s.clippingPlane,...y.clippingPlane),s.transition&&i.uniform1f(s.transition,y.projectionTransition),s.fallbackMatrix&&i.uniformMatrix4fv(s.fallbackMatrix,!1,y.fallbackMatrix);const o=J(_,j),H=ot(p.date),k=K(...ya(re(p.date)),H-ke),f=De([k[0]-o[0],k[1]-o[1],k[2]-o[2]]),d=Math.hypot(...o),P=Math.max(.25*(d-1),.002),U=[o[0]+f[0]*P,o[1]+f[1]*P,o[2]+f[2]*P],G=Math.hypot(...U),B=Math.asin(U[1]/G)*180/Math.PI,A=Math.atan2(U[2],U[0])*180/Math.PI,E=(G-1)*ke,g=j.MercatorCoordinate.fromLngLat([A,B],0);s.centre&&i.uniform2f(s.centre,g.x,g.y),s.elevationGlobe&&i.uniform1f(s.elevationGlobe,E),s.elevationMercator&&i.uniform1f(s.elevationMercator,j.MercatorCoordinate.fromLngLat([A,B],E).z);const w=ca(p.date),m=w*p.haloScale,D=(v.fov||.6435)/2,I=_.getCanvas(),N=Math.tan(m)/Math.tan(D);s.size&&i.uniform2f(s.size,N*(I.height/I.width),N),s.glowAngle&&i.uniform1f(s.glowAngle,m),s.discFraction&&i.uniform1f(s.discFraction,1/p.haloScale),s.discGain&&i.uniform1f(s.discGain,p.discGain);const b=[-o[0]/d,-o[1]/d,-o[2]/d],R=Math.acos(ee(va(b,f),-1,1)),M=Math.asin(ee(1/d,-1,1)),O=ma(R,w,M),Y=f,S=De(Pe([0,1,0],Y)),$=Pe(Y,S);s.forward&&i.uniform3f(s.forward,...Y),s.right&&i.uniform3f(s.right,...S),s.up&&i.uniform3f(s.up,...$),s.camera&&i.uniform3f(s.camera,...o),s.visible&&i.uniform1f(s.visible,O),s.brightness&&i.uniform1f(s.brightness,p.brightness),s.haloStrength&&i.uniform1f(s.haloStrength,p.haloStrength),s.coreColour&&i.uniform3f(s.coreColour,...p.coreColour),s.haloColour&&i.uniform3f(s.haloColour,...p.haloColour),i.bindBuffer(i.ARRAY_BUFFER,x.corner),i.enableVertexAttribArray(F.corner),i.vertexAttribPointer(F.corner,2,i.FLOAT,!1,0,0),i.disable(i.DEPTH_TEST),i.depthMask(!1),i.bindBuffer(i.ELEMENT_ARRAY_BUFFER,x.index),i.drawElements(i.TRIANGLES,Ue.length,i.UNSIGNED_SHORT,0),i.depthMask(!0)},setOptions(c={}){p={...p,...c},_?.triggerRepaint()},getOptions:()=>({...p})}},ee=(e,a,r)=>Math.min(r,Math.max(a,e)),va=(e,a)=>e[0]*a[0]+e[1]*a[1]+e[2]*a[2],De=e=>{const a=Math.hypot(...e)||1;return[e[0]/a,e[1]/a,e[2]/a]},Pe=(e,a)=>[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]],ya=([e,a,r])=>[Math.atan2(r,e)*180/Math.PI,Math.asin(ee(a,-1,1))*180/Math.PI],Ea=it,rt="tm-moon",ne=63710088e-1,Ta=1737400,Q=Math.PI/180,Aa=Date.UTC(2e3,0,1,12),xa=Date.UTC(1999,11,31,0),z=e=>Math.sin(e*Q),q=e=>Math.cos(e*Q),nt=(e=new Date)=>{const a=(e.getTime()-Aa)/864e5,r=(e.getTime()-xa)/864e5,l=125.1228-.0529538083*r,h=5.1454,u=318.0634+.1643573223*r,t=60.2666,_=.0549,i=115.3654+13.0649929509*r;let x=i+_*180/Math.PI*z(i)*(1+_*q(i));for(let m=0;m<3;m++)x-=(x-_*180/Math.PI*z(x)-i)/(1-_*q(x));const L=t*(q(x)-_),p=t*(Math.sqrt(1-_*_)*z(x)),C=Math.atan2(p,L)/Q,c=Math.sqrt(L*L+p*p);let v=c*(q(l)*q(C+u)-z(l)*z(C+u)*q(h)),n=c*(z(l)*q(C+u)+q(l)*z(C+u)*q(h)),y=c*(z(C+u)*z(h));const T=356.047+.9856002585*r,F=282.9404+470935e-10*r+T,s=l+u+i,o=s-F,H=s-l;let k=Math.atan2(n,v)/Q,f=Math.atan2(y,Math.hypot(v,n))/Q;k+=-1.274*z(i-2*o)+.658*z(2*o)-.186*z(T),f+=-.173*z(H-2*o);const d=(c-.58*q(i-2*o)-.46*q(2*o))*ne,P=23.4393-3563e-10*a,U=q(k)*q(f),G=z(k)*q(f)*q(P)-z(f)*z(P),B=z(k)*q(f)*z(P)+z(f)*q(P),A=Math.atan2(G,U)/Q,E=Math.atan2(B,Math.hypot(U,G))/Q,g=(18.697374558+24.06570982441908*a)%24;let w=A-g*15;return w=(w%360+540)%360-180,{lng:w,lat:E,distance:d}},st=(e=new Date)=>{const{lng:a,lat:r,distance:l}=nt(e);return K(a,r,l-ne)},Ra=new Float32Array([-1,-1,1,-1,-1,1,1,1]),Ie=new Uint16Array([0,1,2,1,3,2]),Ma=e=>`${e.vertexShaderPrelude}
${e.define}
attribute vec2 a_corner;
...
}`,Sa=({date:e=new Date,sun:a=[1,0,0],albedoUrl:r=null,sizeScale:l=1,brightness:h=1}={})=>{let u=null,t=null,_=null,i=null,x=!1;const L=new Map;let p={date:e,sun:a,albedoUrl:r,sizeScale:l,brightness:h};const C=v=>{const n=v.variantName;if(L.has(n))return L.get(n);const y=Z(t,Ma(v),ka(),"tm-moon"),T={program:y,attribs:{corner:t.getAttribLocation(y,"a_corner")},uniforms:{centre:t.getUniformLocation(y,"a_centre"),elevationGlobe:t.getUniformLocation(y,"a_elevation_globe"),elevationMercator:t.getUniformLocation(y,"a_elevation_mercator"),size:t.getUniformLocation(y,"u_size"),albedo:t.getUniformLocation(y,"u_albedo"),hasAlbedo:t.getUniformLocation(y,"u_hasAlbedo"),sun:t.getUniformLocation(y,"u_sun"),right:t.getUniformLocation(y,"u_right"),up:t.getUniformLocation(y,"u_up"),forward:t.getUniformLocation(y,"u_forward"),brightness:t.getUniformLocation(y,"u_brightness"),matrix:t.getUniformLocation(y,"u_projection_matrix"),tileMercatorCoords:t.getUniformLocation(y,"u_projection_tile_mercator_coords"),clippingPlane:t.getUniformLocation(y,"u_projection_clipping_plane"),transition:t.getUniformLocation(y,"u_projection_transition"),fallbackMatrix:t.getUniformLocation(y,"u_projection_fallback_matrix")}};return L.set(n,T),T},c=v=>{const n=new Image;n.crossOrigin="anonymous",n.onload=()=>{t&&(i=i||t.createTexture(),t.bindTexture(t.TEXTURE_2D,i),t.texImage2D(t.TEXTURE_2D,0,t.RGBA,t.RGBA,t.UNSIGNED_BYTE,n),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_S,t.REPEAT),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MIN_FILTER,t.LINEAR),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MAG_FILTER,t.LINEAR),x=!0,u?.triggerRepaint())},n.src=v};return{id:rt,type:"custom",renderingMode:"3d",onAdd(v,n){u=v,t=n;const y=t.createBuffer();t.bindBuffer(t.ARRAY_BUFFER,y),t.bufferData(t.ARRAY_BUFFER,Ra,t.STATIC_DRAW);const T=t.createBuffer();t.bindBuffer(t.ELEMENT_ARRAY_BUFFER,T),t.bufferData(t.ELEMENT_ARRAY_BUFFER,Ie,t.STATIC_DRAW),_={corner:y,index:T},p.albedoUrl&&c(p.albedoUrl)},onRemove(){t&&(L.forEach(({program:v})=>t.deleteProgram(v)),L.clear(),i&&(t.deleteTexture(i),i=null,x=!1),_&&(t.deleteBuffer(_.corner),t.deleteBuffer(_.index),_=null),u=null,t=null)},render(v,n){if(!_||p.brightness<=0)return;const y=n&&n.shaderData,T=n&&n.defaultProjectionData;if(!y||!T)return;const{lng:F,lat:s,distance:o}=nt(p.date),{program:H,attribs:k,uniforms:f}=C(y);t.useProgram(H),f.matrix&&t.uniformMatrix4fv(f.matrix,!1,T.mainMatrix),f.tileMercatorCoords&&t.uniform4f(f.tileMercatorCoords,...T.tileMercatorCoords),f.clippingPlane&&t.uniform4f(f.clippingPlane,...T.clippingPlane),f.transition&&t.uniform1f(f.transition,T.projectionTransition),f.fallbackMatrix&&t.uniformMatrix4fv(f.fallbackMatrix,!1,T.fallbackMatrix);const d=J(u,j),P=K(F,s,o-ne),U=Ce([P[0]-d[0],P[1]-d[1],P[2]-d[2]]),B=Math.hypot(...d)+1.2,A=[d[0]+U[0]*B,d[1]+U[1]*B,d[2]+U[2]*B],E=Math.hypot(...A),g=Math.asin(A[1]/E)*180/Math.PI,w=Math.atan2(A[2],A[0])*180/Math.PI,m=(E-1)*ne,D=j.MercatorCoordinate.fromLngLat([w,g],0);f.centre&&t.uniform2f(f.centre,D.x,D.y),f.elevationGlobe&&t.uniform1f(f.elevationGlobe,m),f.elevationMercator&&t.uniform1f(f.elevationMercator,j.MercatorCoordinate.fromLngLat([w,g],m).z);const I=Math.atan(Ta*p.sizeScale/o),N=(n.fov||.6435)/2,b=u.getCanvas(),R=Math.tan(I)/Math.tan(N);f.size&&t.uniform2f(f.size,R*(b.height/b.width),R);const M=U,O=Ce(Fe([0,1,0],M)),Y=Fe(M,O);f.forward&&t.uniform3f(f.forward,...M),f.right&&t.uniform3f(f.right,...O),f.up&&t.uniform3f(f.up,...Y),f.sun&&t.uniform3f(f.sun,...p.sun),f.brightness&&t.uniform1f(f.brightness,p.brightness),f.hasAlbedo&&t.uniform1f(f.hasAlbedo,x?1:0),x&&f.albedo&&(t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,i),t.uniform1i(f.albedo,0)),t.bindBuffer(t.ARRAY_BUFFER,_.corner),t.enableVertexAttribArray(k.corner),t.vertexAttribPointer(k.corner,2,t.FLOAT,!1,0,0),t.enable(t.DEPTH_TEST),t.depthFunc(t.LEQUAL),t.depthMask(!1),t.bindBuffer(t.ELEMENT_ARRAY_BUFFER,_.index),t.drawElements(t.TRIANGLES,Ie.length,t.UNSIGNED_SHORT,0),t.depthMask(!0)},setOptions(v={}){const n=p.albedoUrl;p={...p,...v},v.albedoUrl!==void 0&&v.albedoUrl!==n&&(x=!1,v.albedoUrl&&c(v.albedoUrl)),u?.triggerRepaint()},getOptions:()=>({...p}),get hasAlbedo(){return x}}},Ce=e=>{const a=Math.hypot(...e)||1;return[e[0]/a,e[1]/a,e[2]/a]},Fe=(e,a)=>[e[1]*a[2]-e[2]*a[1],e[2]*a[0]-e[0]*a[2],e[0]*a[1]-e[1]*a[0]],La=rt,Ua=6957e5,Da=1737400,Pa=63710088e-1,Ia=Da/Pa,Ca=(e,a,r)=>Math.min(r,Math.max(a,e)),Fa=(e=new Date)=>Math.asin(Ua/da(e)),Na=.035,Oa=(e=new Date,a=null,r=null)=>{const l=a||re(e),h=r||st(e),u=Math.hypot(...h);return Math.acos(Ca((l[0]*h[0]+l[1]*h[1]+l[2]*h[2])/u,-1,1))<Na},Ba=`
...
}`,za=({sun:e=[1,0,0],nightDarkness:a=.965,lightsUrl:r=null,lightsAmount:l=0,nightColour:h=[.02,.035,.07],twilightColour:u=[.62,.32,.16],twilightCool:t=[.1,.15,.28],twilightStrength:_=.55,reliefUrl:i=null,reliefWidth:x=8192,reliefPower:L=1.5,cloudShadow:p=.5,eclipse:C=!0,date:c=null,fieldUrl:v=null,patchUrl:n=null,windUrl:y=null,windAmount:T=1,windScale:F=.06,windRate:s=.05,driftRate:o=4e-4,animate:H=!0}={})=>{const k=le();let f=null,d=null,P=null,U=null,G=null,B=null,A=null,E=null;const g=new Map;let w={sun:e,nightDarkness:a,lightsUrl:r,lightsAmount:l,nightColour:h,twilightColour:u,twilightCool:t,twilightStrength:_,reliefUrl:i,reliefWidth:x,reliefPower:L,cloudShadow:p,eclipse:C,date:c,fieldUrl:v,patchUrl:n,windUrl:y,windAmount:T,windScale:F,windRate:s,driftRate:o,animate:H};const m=N=>{const b=N.variantName;if(g.has(b))return g.get(b);const R=Z(d,Ha(N),Ga(),"tm-daylight"),M={program:R,attribs:{pos:d.getAttribLocation(R,"a_pos"),sphere:d.getAttribLocation(R,"a_sphere")},uniforms:{elevationGlobe:d.getUniformLocation(R,"a_elevation_globe"),elevationMercator:d.getUniformLocation(R,"a_elevation_mercator"),sun:d.getUniformLocation(R,"u_sun"),camera:d.getUniformLocation(R,"u_camera"),globeness:d.getUniformLocation(R,"u_globeness"),nightDarkness:d.getUniformLocation(R,"u_nightDarkness"),nightColour:d.getUniformLocation(R,"u_nightColour"),twilightColour:d.getUniformLocation(R,"u_twilightColour"),twilightCool:d.getUniformLocation(R,"u_twilightCool"),twilightStrength:d.getUniformLocation(R,"u_twilightStrength"),lights:d.getUniformLocation(R,"u_lights"),lightsAmount:d.getUniformLocation(R,"u_lightsAmount"),relief:d.getUniformLocation(R,"u_relief"),reliefPower:d.getUniformLocation(R,"u_reliefPower"),cloudShadow:d.getUniformLocation(R,"u_cloudShadow"),cloudAltitude:d.getUniformLocation(R,"u_cloudAltitude"),moon:d.getUniformLocation(R,"u_moon"),sunRadius:d.getUniformLocation(R,"u_sunRadius"),...Object.fromEntries(je.map(O=>[O,d.getUniformLocation(R,`u_${O}`)])),matrix:d.getUniformLocation(R,"u_projection_matrix"),tileMercatorCoords:d.getUniformLocation(R,"u_projection_tile_mercator_coords"),clippingPlane:d.getUniformLocation(R,"u_projection_clipping_plane"),transition:d.getUniformLocation(R,"u_projection_transition"),fallbackMatrix:d.getUniformLocation(R,"u_projection_fallback_matrix")}};return g.set(b,M),M},D=()=>f?.triggerRepaint(),I=(N,b,R,M)=>{!b?.ready||!N[R]||(d.activeTexture(d.TEXTURE0+M),d.bindTexture(d.TEXTURE_2D,b.texture),d.uniform1i(N[R],M))};return{id:lt,type:"custom",renderingMode:"3d",onAdd(N,b){f=N,d=b;const R=(M,O)=>{const Y=d.createBuffer();return d.bindBuffer(M,Y),d.bufferData(M,O,d.STATIC_DRAW),Y};P={pos:R(d.ARRAY_BUFFER,k.positions),sphere:R(d.ARRAY_BUFFER,k.spheres),index:R(d.ELEMENT_ARRAY_BUFFER,k.indices)},w.lightsUrl&&(U=W(d,w.lightsUrl,D)),w.reliefUrl&&(G=W(d,w.reliefUrl,D)),w.fieldUrl&&(B=W(d,w.fieldUrl,D)),w.windUrl&&(A=W(d,w.windUrl,D)),w.patchUrl&&(E=W(d,w.patchUrl,D))},onRemove(){d&&(g.forEach(({program:N})=>d.deleteProgram(N)),g.clear(),U?.release(),U=null,G?.release(),G=null,B?.release(),B=null,A?.release(),A=null,E?.release(),E=null,P&&(d.deleteBuffer(P.pos),d.deleteBuffer(P.sphere),d.deleteBuffer(P.index),P=null),f=null,d=null)},render(N,b){if(!P||w.nightDarkness<=0)return;const R=b&&b.shaderData,M=b&&b.defaultProjectionData;if(!R||!M)return;const{program:O,attribs:Y,uniforms:S}=m(R);d.useProgram(O),S.matrix&&d.uniformMatrix4fv(S.matrix,!1,M.mainMatrix),S.tileMercatorCoords&&d.uniform4f(S.tileMercatorCoords,...M.tileMercatorCoords),S.clippingPlane&&d.uniform4f(S.clippingPlane,...M.clippingPlane),S.transition&&d.uniform1f(S.transition,M.projectionTransition),S.fallbackMatrix&&d.uniformMatrix4fv(S.fallbackMatrix,!1,M.fallbackMatrix);const $=f.getCenter().lat,Ee=0;S.elevationGlobe&&d.uniform1f(S.elevationGlobe,Ee),S.elevationMercator&&d.uniform1f(S.elevationMercator,j.MercatorCoordinate.fromLngLat([0,$],Ee).z),S.sun&&d.uniform3f(S.sun,...w.sun),S.camera&&d.uniform3f(S.camera,...J(f,j)),S.globeness&&d.uniform1f(S.globeness,M.projectionTransition),S.nightDarkness&&d.uniform1f(S.nightDarkness,w.nightDarkness),S.nightColour&&d.uniform3f(S.nightColour,...w.nightColour),S.twilightColour&&d.uniform3f(S.twilightColour,...w.twilightColour),S.twilightCool&&d.uniform3f(S.twilightCool,...w.twilightCool),S.twilightStrength&&d.uniform1f(S.twilightStrength,w.twilightStrength),S.lightsAmount&&d.uniform1f(S.lightsAmount,U?.ready?w.lightsAmount:0);const ft=G?.ready?St(f.getZoom(),$,w.reliefWidth).strength:0;S.reliefPower&&d.uniform1f(S.reliefPower,w.reliefPower*ft),S.cloudShadow&&d.uniform1f(S.cloudShadow,w.cloudShadow),S.cloudAltitude&&d.uniform1f(S.cloudAltitude,oe/se);const ae=w.eclipse?w.date:null,de=ae&&Oa(ae)?st(ae):null;S.sunRadius&&d.uniform1f(S.sunRadius,de?Fa(ae):0),de&&S.moon&&d.uniform3f(S.moon,...de),Ye(d,S,w,{seconds:performance.now()*.001,field:B,wind:A,patches:E},te.field,te.wind,te.patches),I(S,G,"relief",te.relief),I(S,U,"lights",te.lights),d.bindBuffer(d.ARRAY_BUFFER,P.pos),d.enableVertexAttribArray(Y.pos),d.vertexAttribPointer(Y.pos,2,d.FLOAT,!1,0,0),d.bindBuffer(d.ARRAY_BUFFER,P.sphere),d.enableVertexAttribArray(Y.sphere),d.vertexAttribPointer(Y.sphere,3,d.FLOAT,!1,0,0),d.disable(d.DEPTH_TEST),d.depthMask(!1),d.bindBuffer(d.ELEMENT_ARRAY_BUFFER,P.index),d.drawElements(d.TRIANGLES,k.indices.length,d.UNSIGNED_SHORT,0),d.enable(d.DEPTH_TEST),d.depthMask(!0),w.animate&&(B?.ready||E?.ready)&&w.cloudShadow>0&&f.triggerRepaint()},setOptions(N={}){const b=w;if(w={...w,...N},!d){f?.triggerRepaint();return}const R=(M,O)=>N[O]===void 0||N[O]===b[O]?M:(M?.release(),w[O]?W(d,w[O],D):null);U=R(U,"lightsUrl"),G=R(G,"reliefUrl"),B=R(B,"fieldUrl"),A=R(A,"windUrl"),E=R(E,"patchUrl"),f?.triggerRepaint()},getOptions:()=>({...w}),get hasLights(){return!!U?.ready},get hasRelief(){return!!G?.ready}}},$a=lt,ht="tm-atmosphere",qa=63710088e-1,me=2e5,ja=e=>`${e.vertexShaderPrelude}
${e.define}
attribute vec2 a_pos;
...
}`,Xa=({strength:e=1,sun:a=[.4,.5,.75],dayColour:r=[.32,.55,1],duskColour:l=[1,.45,.18]}={})=>{const h=le();let u=null,t=null,_=null;const i=new Map;let x={strength:e,sun:a,dayColour:r,duskColour:l};const L=p=>{const C=p.variantName;if(i.has(C))return i.get(C);const c=Z(t,ja(p),Ya(),"tm-atmosphere"),v={program:c,attribs:{pos:t.getAttribLocation(c,"a_pos"),sphere:t.getAttribLocation(c,"a_sphere")},uniforms:{elevationGlobe:t.getUniformLocation(c,"a_elevation_globe"),elevationMercator:t.getUniformLocation(c,"a_elevation_mercator"),camera:t.getUniformLocation(c,"u_camera"),sun:t.getUniformLocation(c,"u_sun"),top:t.getUniformLocation(c,"u_top"),strength:t.getUniformLocation(c,"u_strength"),dayColour:t.getUniformLocation(c,"u_dayColour"),duskColour:t.getUniformLocation(c,"u_duskColour"),matrix:t.getUniformLocation(c,"u_projection_matrix"),tileMercatorCoords:t.getUniformLocation(c,"u_projection_tile_mercator_coords"),clippingPlane:t.getUniformLocation(c,"u_projection_clipping_plane"),transition:t.getUniformLocation(c,"u_projection_transition"),fallbackMatrix:t.getUniformLocation(c,"u_projection_fallback_matrix")}};return i.set(C,v),v};return{id:ht,type:"custom",renderingMode:"3d",onAdd(p,C){u=p,t=C;const c=(v,n)=>{const y=t.createBuffer();return t.bindBuffer(v,y),t.bufferData(v,n,t.STATIC_DRAW),y};_={pos:c(t.ARRAY_BUFFER,h.positions),sphere:c(t.ARRAY_BUFFER,h.spheres),index:c(t.ELEMENT_ARRAY_BUFFER,h.indices)}},onRemove(){t&&(i.forEach(({program:p})=>t.deleteProgram(p)),i.clear(),_&&(t.deleteBuffer(_.pos),t.deleteBuffer(_.sphere),t.deleteBuffer(_.index),_=null),u=null,t=null)},render(p,C){if(!_||x.strength<=0)return;const c=C&&C.shaderData,v=C&&C.defaultProjectionData;if(!c||!v)return;const{program:n,attribs:y,uniforms:T}=L(c);t.useProgram(n),T.matrix&&t.uniformMatrix4fv(T.matrix,!1,v.mainMatrix),T.tileMercatorCoords&&t.uniform4f(T.tileMercatorCoords,...v.tileMercatorCoords),T.clippingPlane&&t.uniform4f(T.clippingPlane,...v.clippingPlane),T.transition&&t.uniform1f(T.transition,v.projectionTransition),T.fallbackMatrix&&t.uniformMatrix4fv(T.fallbackMatrix,!1,v.fallbackMatrix);const F=u.getCenter().lat;T.elevationGlobe&&t.uniform1f(T.elevationGlobe,me),T.elevationMercator&&t.uniform1f(T.elevationMercator,j.MercatorCoordinate.fromLngLat([0,F],me).z);const s=J(u,j);T.camera&&t.uniform3f(T.camera,s[0],s[1],s[2]),T.sun&&t.uniform3f(T.sun,...x.sun),T.top&&t.uniform1f(T.top,1+me/qa),T.strength&&t.uniform1f(T.strength,x.strength),T.dayColour&&t.uniform3f(T.dayColour,...x.dayColour),T.duskColour&&t.uniform3f(T.duskColour,...x.duskColour),t.bindBuffer(t.ARRAY_BUFFER,_.pos),t.enableVertexAttribArray(y.pos),t.vertexAttribPointer(y.pos,2,t.FLOAT,!1,0,0),t.bindBuffer(t.ARRAY_BUFFER,_.sphere),t.enableVertexAttribArray(y.sphere),t.vertexAttribPointer(y.sphere,3,t.FLOAT,!1,0,0),t.enable(t.DEPTH_TEST),t.depthFunc(t.LEQUAL),t.depthMask(!1),t.bindBuffer(t.ELEMENT_ARRAY_BUFFER,_.index),t.drawElements(t.TRIANGLES,h.indices.length,t.UNSIGNED_SHORT,0),t.depthMask(!0)},setOptions(p={}){x={...x,...p},u?.triggerRepaint()},getOptions:()=>({...x})}},Wa=ht,Ka=32,ct=[{width:8192,height:4096,url:"/timemap/ocean-sdf-8192.webp"},{width:4096,height:2048,url:"/timemap/ocean-sdf-4096.webp"}],Va=`
...
void main() {
  ...
  gl_FragColor = vec4(colour * alpha, alpha);
}`,Ja=(e,{fadeInAbove:a=9e5,fadeOutBelow:r=18e4}={})=>{const l=Math.max(0,Math.min(1,(e-r)/(a-r)));return l*l*(3-2*l)},eo=(e,a,r=.8)=>{const l=156543.03392*Math.cos(a*Math.PI/180)/Math.pow(2,e);return Math.max(r,l*1.5/1e3)},to=40075,ao=e=>Number.isFinite(e)&&e>0?to/e/2:.8,Ne=(e,a=ct)=>a.find(r=>r.width<=e&&r.height<=e)||null,oo=({opacity:e=1,strength:a=.9,roughness:r=.55,windPatch:l=.3,windScale:h=14,edgeRemap:u=0,sun:t=[.4,.5,.75],water:_=1,absorption:i=[.45,.06,.02],scatter:x=[.12,.265,.43],bottom:L=[.42,.4,.33],sky:p=[.34,.5,.76],shelfKm:C=22,shelfDepthM:c=16,shoreSoftnessKm:v=.8,fadeInAbove:n=9e5,fadeOutBelow:y=18e4,sources:T=ct}={})=>{const F=le();let s=null,o=null,H=null,k=null,f=null,d=!1;const P=new Map;let U={opacity:e,strength:a,roughness:r,windPatch:l,windScale:h,edgeRemap:u,sun:t,water:_,absorption:i,scatter:x,bottom:L,sky:p,shelfKm:C,shelfDepthM:c,shoreSoftnessKm:v,fadeInAbove:n,fadeOutBelow:y,sources:T};const G=g=>{const w=g.variantName;if(P.has(w))return P.get(w);const m=Z(o,Za(g),Qa(),"tm-ocean",{es300:!0}),D={program:m,attribs:{pos:o.getAttribLocation(m,"a_pos"),sphere:o.getAttribLocation(m,"a_sphere")},uniforms:{elevationGlobe:o.getUniformLocation(m,"a_elevation_globe"),elevationMercator:o.getUniformLocation(m,"a_elevation_mercator"),camera:o.getUniformLocation(m,"u_camera"),sun:o.getUniformLocation(m,"u_sun"),globeness:o.getUniformLocation(m,"u_globeness"),field:o.getUniformLocation(m,"u_field"),rangeKm:o.getUniformLocation(m,"u_rangeKm"),shoreKm:o.getUniformLocation(m,"u_shoreKm"),shelfKm:o.getUniformLocation(m,"u_shelfKm"),strength:o.getUniformLocation(m,"u_strength"),roughness:o.getUniformLocation(m,"u_roughness"),windPatch:o.getUniformLocation(m,"u_windPatch"),windScale:o.getUniformLocation(m,"u_windScale"),water:o.getUniformLocation(m,"u_water"),scatter:o.getUniformLocation(m,"u_scatter"),bottom:o.getUniformLocation(m,"u_bottom"),absorption:o.getUniformLocation(m,"u_absorption"),shelfDepthM:o.getUniformLocation(m,"u_shelfDepthM"),sky:o.getUniformLocation(m,"u_sky"),fade:o.getUniformLocation(m,"u_fade"),opacity:o.getUniformLocation(m,"u_opacity"),edgeRemap:o.getUniformLocation(m,"u_edgeRemap"),matrix:o.getUniformLocation(m,"u_projection_matrix"),tileMercatorCoords:o.getUniformLocation(m,"u_projection_tile_mercator_coords"),clippingPlane:o.getUniformLocation(m,"u_projection_clipping_plane"),transition:o.getUniformLocation(m,"u_projection_transition"),fallbackMatrix:o.getUniformLocation(m,"u_projection_fallback_matrix")}};return P.set(w,D),D},B=()=>{f=o.createTexture(),o.bindTexture(o.TEXTURE_2D,f),o.texImage2D(o.TEXTURE_2D,0,o.LUMINANCE,1,1,0,o.LUMINANCE,o.UNSIGNED_BYTE,new Uint8Array([0])),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MIN_FILTER,o.LINEAR),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MAG_FILTER,o.LINEAR),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_S,o.CLAMP_TO_EDGE),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_T,o.CLAMP_TO_EDGE)},A=g=>{o&&(f&&o.deleteTexture(f),f=o.createTexture(),o.bindTexture(o.TEXTURE_2D,f),o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,!1),$e(o)?o.texImage2D(o.TEXTURE_2D,0,o.R8,o.RED,o.UNSIGNED_BYTE,g):o.texImage2D(o.TEXTURE_2D,0,o.LUMINANCE,o.LUMINANCE,o.UNSIGNED_BYTE,g),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_S,o.REPEAT),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_T,o.CLAMP_TO_EDGE),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MIN_FILTER,o.LINEAR_MIPMAP_LINEAR),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MAG_FILTER,o.LINEAR),o.generateMipmap(o.TEXTURE_2D),d=!0,s?.triggerRepaint())},E=()=>{const g=Ne(o.getParameter(o.MAX_TEXTURE_SIZE),U.sources);if(!g)return;const w=g.url;H=g.width,fetch(w,{credentials:"omit"}).then(m=>m.ok?m.blob():Promise.reject(new Error(m.status))).then(m=>createImageBitmap(m,{colorSpaceConversion:"none",premultiplyAlpha:"none",imageOrientation:"none"})).then(m=>{if(Ne(o?.getParameter(o.MAX_TEXTURE_SIZE)??0,U.sources)?.url!==w){m.close?.();return}A(m),m.close?.()}).catch(()=>{})};return{id:dt,type:"custom",renderingMode:"3d",onAdd(g,w){s=g,o=w;const m=(D,I)=>{const N=o.createBuffer();return o.bindBuffer(D,N),o.bufferData(D,I,o.STATIC_DRAW),N};k={pos:m(o.ARRAY_BUFFER,F.positions),sphere:m(o.ARRAY_BUFFER,F.spheres),index:m(o.ELEMENT_ARRAY_BUFFER,F.indices)},B(),E()},onRemove(){o&&(P.forEach(({program:g})=>o.deleteProgram(g)),P.clear(),f&&(o.deleteTexture(f),f=null,d=!1),k&&(o.deleteBuffer(k.pos),o.deleteBuffer(k.sphere),o.deleteBuffer(k.index),k=null),s=null,o=null)},render(g,w){if(!k||U.opacity<=0)return;const m=w&&w.shaderData,D=w&&w.defaultProjectionData;if(!m||!D)return;const{program:I,attribs:N,uniforms:b}=G(m);o.useProgram(I),b.matrix&&o.uniformMatrix4fv(b.matrix,!1,D.mainMatrix),b.tileMercatorCoords&&o.uniform4f(b.tileMercatorCoords,...D.tileMercatorCoords),b.clippingPlane&&o.uniform4f(b.clippingPlane,...D.clippingPlane),b.transition&&o.uniform1f(b.transition,D.projectionTransition),b.fallbackMatrix&&o.uniformMatrix4fv(b.fallbackMatrix,!1,D.fallbackMatrix);const R=s.getCenter(),M=0;b.elevationGlobe&&o.uniform1f(b.elevationGlobe,M),b.elevationMercator&&o.uniform1f(b.elevationMercator,j.MercatorCoordinate.fromLngLat([0,R.lat],M).z),b.camera&&o.uniform3f(b.camera,...J(s,j)),b.sun&&o.uniform3f(b.sun,...U.sun),b.globeness&&o.uniform1f(b.globeness,D.projectionTransition),b.field&&(o.activeTexture(o.TEXTURE0),o.bindTexture(o.TEXTURE_2D,f),o.uniform1i(b.field,0)),b.rangeKm&&o.uniform1f(b.rangeKm,Ka),b.shoreKm&&o.uniform1f(b.shoreKm,eo(s.getZoom(),R.lat,Math.max(U.shoreSoftnessKm,ao(H)))),b.shelfKm&&o.uniform1f(b.shelfKm,U.shelfKm),b.strength&&o.uniform1f(b.strength,U.strength),b.roughness&&o.uniform1f(b.roughness,U.roughness),b.windPatch&&o.uniform1f(b.windPatch,U.windPatch),b.windScale&&o.uniform1f(b.windScale,U.windScale),b.water&&o.uniform1f(b.water,U.water),b.scatter&&o.uniform3f(b.scatter,...U.scatter),b.bottom&&o.uniform3f(b.bottom,...U.bottom),b.absorption&&o.uniform3f(b.absorption,...U.absorption),b.shelfDepthM&&o.uniform1f(b.shelfDepthM,U.shelfDepthM),b.sky&&o.uniform3f(b.sky,...U.sky),b.opacity&&o.uniform1f(b.opacity,U.opacity),b.edgeRemap&&o.uniform1f(b.edgeRemap,U.edgeRemap),b.fade&&o.uniform1f(b.fade,Ja(ve(s,j),U)),o.bindBuffer(o.ARRAY_BUFFER,k.pos),o.enableVertexAttribArray(N.pos),o.vertexAttribPointer(N.pos,2,o.FLOAT,!1,0,0),o.bindBuffer(o.ARRAY_BUFFER,k.sphere),o.enableVertexAttribArray(N.sphere),o.vertexAttribPointer(N.sphere,3,o.FLOAT,!1,0,0),o.disable(o.DEPTH_TEST),o.depthMask(!1),o.bindBuffer(o.ELEMENT_ARRAY_BUFFER,k.index),o.drawElements(o.TRIANGLES,F.indices.length,o.UNSIGNED_SHORT,0),o.enable(o.DEPTH_TEST),o.depthMask(!0)},setOptions(g={}){const w=U.sources;U={...U,...g},g.sources!==void 0&&g.sources!==w&&(d=!1,o&&E()),s?.triggerRepaint()},getOptions:()=>({...U}),get hasField(){return d}}},io=dt,ye=[{key:"starfield",option:"brightness",label:"Stars",default:.5,max:1},{key:"sun",option:"brightness",label:"Sun",default:1,max:1},{key:"moon",option:"brightness",label:"Moon",default:1,max:1},{key:"daylight",option:"nightDarkness",label:"Day and night",default:.965,max:1},{key:"atmosphere",option:"strength",label:"Atmosphere",default:1,max:1},{key:"clouds",option:"opacity",label:"Clouds",default:1,max:1},{key:"ocean",option:"opacity",label:"Ocean",default:1,max:1},{key:"relief",option:"reliefPower",label:"Relief",default:0,max:2,on:"daylight"}],_e={key:"reference",default:0},ro="tm-layers-v2",no=(e=globalThis.localStorage)=>{const a={};for(const r of ye)a[r.key]={visible:r.default>0,value:r.default};a[_e.key]={visible:!1,value:_e.default};try{const r=JSON.parse(e?.getItem(ro)||"{}");for(const[l,h]of Object.entries(r)){if(!a[l]||!h||typeof h!="object")continue;const u=h.value;a[l]={visible:h.visible===!0,value:typeof u=="number"&&Number.isFinite(u)?u:a[l].value}}}catch{}return a},so=(e,a)=>{const r=a?.visible?Number(a.value):0;return{[e.option]:Number.isFinite(r)?r:0}},lo=(e,a)=>{const r=[];for(const l of ye){const h=e?.[l.on||l.key];!h||typeof h.setOptions!="function"||(h.setOptions(so(l,a?.[l.key])),r.push(l.key))}return r},ho=(e,{onReference:a=null,target:r=globalThis}={})=>{const l=new Map(ye.map(h=>[h.key,h]));return r.__tmSetLayer=(h,u)=>{const t=Number.isFinite(Number(u))?Number(u):0;if(h===_e.key)return a?.(t);const _=l.get(h);if(!_)return;const i=e?.[_.on||_.key];if(!(!i||typeof i.setOptions!="function"))return i.setOptions({[_.option]:t})},()=>{r.__tmSetLayer&&delete r.__tmSetLayer}},co="/img/map/clouds-field.webp",uo="/img/map/wind-field.png",Oe="/img/map/cloud-patches.webp",pe=e=>mt(e).rgb.map(a=>a/255),Be=[["starfield",na,e=>ra(e)],["sun",Ea,e=>ba(e)],["moon",La,e=>Sa(e)],["ocean",io,e=>oo(e)],["daylight",$a,e=>za(e)],["clouds",Ct,e=>It(e)],["atmosphere",Wa,e=>Xa(e)]],ut=(e,a)=>{if(a&&e.getLayer(a))return a;let r;try{r=(e.getStyle()?.layers??[]).find(l=>l.type==="symbol"&&l.layout?.["text-field"]!=null)?.id}catch{}return a&&console.warn(`[globe-layers] "${a}" is not on this map; ${r?`anchoring under "${r}" so the labels stay readable`:"and nothing on it draws text, so the stack goes on top"}`),r},fo=(e,{date:a=new Date,reduceMotion:r=!1,beforeId:l}={})=>{const h=re(a),u=!r,t={fieldUrl:co,patchUrl:Oe,windUrl:uo,windAmount:.2,animate:u},_={starfield:{date:a,animate:u},sun:{date:a},moon:{date:a,sun:h},ocean:{sun:h,roughness:.95,strength:.48,windPatch:.6,shoreSoftnessKm:19.5},clouds:{...t,sun:h},daylight:{...t,sun:h,date:a},atmosphere:{sun:h,strength:1.25}},i={},x=ut(e,l);for(const[c,v,n]of Be){e.getLayer(v)&&e.removeLayer(v);const y=n(_[c]);e.addLayer(y,x),i[c]=y}lo(i,no());const L=ho(i),p=(c,v)=>i[c]?.setOptions?.(v),C=[window.__tune?.register("Ocean",[{key:"shoreSoftnessKm",label:"Shore falloff",min:0,max:25,step:.25,value:19.5,apply:c=>p("ocean",{shoreSoftnessKm:c})},{key:"roughness",label:"Roughness",min:0,max:1,step:.01,value:.95,apply:c=>p("ocean",{roughness:c})},{key:"strength",label:"Sun glint",min:0,max:1,step:.01,value:.48,apply:c=>p("ocean",{strength:c})},{key:"windPatch",label:"Patchiness",min:0,max:1,step:.01,value:.6,apply:c=>p("ocean",{windPatch:c})},{key:"windScale",label:"Wave scale",min:1,max:60,step:1,value:14,apply:c=>p("ocean",{windScale:c})},{key:"water",label:"Tint depth",min:0,max:2,step:.05,value:1,apply:c=>p("ocean",{water:c})},{key:"scatter",label:"Tint colour",type:"color",value:"#1d5c8f",apply:c=>p("ocean",{scatter:pe(c)})},{key:"opacity",label:"Opacity",min:0,max:1,step:.01,value:1,apply:c=>p("ocean",{opacity:c})}],{tab:"Earth"}),window.__tune?.register("Clouds",[{key:"opacity",label:"Density",min:0,max:1,step:.01,value:1,apply:c=>p("clouds",{opacity:c})},{key:"windAmount",label:"Curl",min:0,max:1,step:.05,value:.2,apply:c=>p("clouds",{windAmount:c})},{key:"windScale",label:"Wind scale",min:.01,max:.5,step:.01,value:.06,apply:c=>p("clouds",{windScale:c})},{key:"windRate",label:"Wind speed",min:0,max:.3,step:.005,value:.05,apply:c=>p("clouds",{windRate:c})},{key:"cloudShadow",label:"Shadows",min:0,max:1,step:.01,value:.5,apply:c=>p("daylight",{cloudShadow:c})},{key:"patchTiles",label:"Cloud cells",min:96,max:320,step:8,value:144,apply:c=>{p("clouds",{patchTiles:c}),p("daylight",{patchTiles:c})}},{key:"patchMean",label:"Atlas mean",min:.2,max:.8,step:.005,value:.4359,apply:c=>{p("clouds",{patchMean:c}),p("daylight",{patchMean:c})}},{key:"patchDetail",label:"Detail amount",min:0,max:1.5,step:.05,value:.75,apply:c=>{p("clouds",{patchDetail:c}),p("daylight",{patchDetail:c})}},{key:"patchUrl",label:"Tiled source",type:"boolean",value:!0,apply:c=>{const v=c?Oe:null;p("clouds",{patchUrl:v}),p("daylight",{patchUrl:v})}}],{tab:"Earth"}),window.__tune?.register("Cloud light",[{key:"cloudRelief",label:"Cloud height km",min:0,max:120,step:2,value:90,apply:c=>p("clouds",{cloudRelief:c})},{key:"cloudDepth",label:"Optical depth",min:0,max:12,step:.25,value:4,apply:c=>p("clouds",{cloudDepth:c})},{key:"powder",label:"Powder",min:0,max:1,step:.05,value:1,apply:c=>p("clouds",{powder:c})},{key:"forward",label:"Silver lining",min:0,max:2,step:.05,value:.5,apply:c=>p("clouds",{forward:c})},{key:"forwardG",label:"Lobe sharpness",min:0,max:.95,step:.05,value:.7,apply:c=>p("clouds",{forwardG:c})},{key:"selfShadow",label:"Self shadow",min:0,max:1,step:.02,value:.18,apply:c=>p("clouds",{selfShadow:c})},{key:"selfShadowStep",label:"Shadow reach",min:2e-4,max:.006,step:2e-4,value:.0015,apply:c=>p("clouds",{selfShadowStep:c})}],{tab:"Earth"}),window.__tune?.register("Sky and light",[{key:"nightDarkness",label:"Night",min:0,max:1,step:.005,value:.965,apply:c=>p("daylight",{nightDarkness:c})},{key:"twilightColour",label:"Twilight warm",type:"color",value:"#9e5229",apply:c=>p("daylight",{twilightColour:pe(c)})},{key:"twilightCool",label:"Twilight blue",type:"color",value:"#1a2647",apply:c=>p("daylight",{twilightCool:pe(c)})},{key:"twilightStrength",label:"Twilight strength",min:0,max:1,step:.05,value:.55,apply:c=>p("daylight",{twilightStrength:c})},{key:"atmosphere",label:"Haze",min:0,max:2,step:.05,value:1.25,apply:c=>p("atmosphere",{strength:c})},{key:"starfield",label:"Stars",min:0,max:1,step:.05,value:.5,apply:c=>p("starfield",{brightness:c})},{key:"sun",label:"Sun",min:0,max:2,step:.05,value:1,apply:c=>p("sun",{brightness:c})},{key:"moon",label:"Moon",min:0,max:2,step:.05,value:1,apply:c=>p("moon",{brightness:c})}],{tab:"Earth"})];return{layers:i,setDate(c){const v=c instanceof Date?c:new Date(c);if(Number.isNaN(v.getTime()))return;const n=re(v);for(const y of Object.keys(i))i[y]?.setOptions?.({date:v,sun:n})},remove(){L?.();for(const c of C)c?.();for(const[,c]of Be)e.getLayer(c)&&e.removeLayer(c)}}},go=Object.freeze(Object.defineProperty({__proto__:null,addGlobeLayers:fo,globeAnchorId:ut},Symbol.toStringTag,{value:"Module"}));export{Ct as C,fo as a,go as m,K as p,re as s};
