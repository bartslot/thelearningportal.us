...
<div class="fixed inset-x-0 bottom-0 top-16 z-20"
    ...
    <div class="absolute right-4 top-4 z-30"
        ...
        {{-- Palette sub-button (to the left).
             ...
             LOST IN THE MERGE AND PUT BACK. polishing-1 removed this in its fewer-choices pass and
             that deletion auto-merged, while the x-data holding `paletteOpen`, `style` and `items`
             was inside a conflict and kept map-integration's side. The result was state with no UI:
             three styles defined, a variable to hold the choice, and nothing on screen that could
             make one. Reported as "I can't switch styles on 8030", which is exactly what it was. --}}
        {{-- Palette sub-button (to the left) --}}
