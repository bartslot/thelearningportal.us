...
<div class="space-y-3 text-sm">
    ...
    {{-- MAP STYLE — the four front-end Time-Map palettes as Europe preview swatches. This sets the
         LESSON-WIDE default (every map block inherits it), so teachers pick once. Clicking a swatch
         repaints the live preview instantly (lessonmap:style) and persists via setLessonMapStyle. --}}
    @php
        $effectiveStyle = $scene->config['map_style'] ?? $lessonMapStyle ?? 'soft-atlas';
        $styleOptions = [
